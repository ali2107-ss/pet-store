...
const reviews: Review[] = [
  { id: 1, user: 'Анна К.', rating: 5, text: 'Быстрая доставка...', date: '2 недели назад' },
  { id: 2, user: 'Иван П.', rating: 4, text: 'Качественный ошейник...', date: '1 месяц назад' },
  { id: 3, user: 'Ольга М.', rating: 5, text: 'Просто лучший сервис!', date: '3 дня назад' },
  { id: 4, user: 'Дмитрий С.', rating: 5, text: 'Игрушки очень прочные...', date: '3 месяца назад' },
];
